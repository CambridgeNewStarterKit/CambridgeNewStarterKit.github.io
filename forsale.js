function edit_row(no)
{
 ...
 var discription=document.getElementById("discription_row"+no);
...
function add_row()
{
 ...
 var new_discription=document.getElementById("new_discription").value;
 ...
 document.getElementById("new_discription").value="";
